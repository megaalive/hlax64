...
```powershell
hla64 build examples/interop/11-csharp-interop-real/native_count_lines/native_count_lines.hla64 `
...
```powershell
hla64 generate-pinvoke examples/interop/11-csharp-interop-real/native_count_lines/native_count_lines.hla64 `
  -l native_count_lines -o examples/interop/11-csharp-interop-real/native_count_lines/caller/HlaX64Interop.cs
```

## Run C# caller

```powershell
cd examples/interop/11-csharp-interop-real/native_count_lines/caller
