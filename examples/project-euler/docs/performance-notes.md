...
```bash
hla64 bench examples/project-euler/problems/euler001-multiples-of-3-and-5-bruteforce.hla64
hla64 bench examples/project-euler/problems/euler001-multiples-of-3-and-5-formula.hla64
```
